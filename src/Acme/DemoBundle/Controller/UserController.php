...
class UserController extends Controller
{
    ...
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            if ($entity->getPassword() != $entity->getPassword2())
            {
                $error = 'Vérifier le mot de passe !' ;
                
                return $this->render('AcmeDemoBundle:User:main.html.twig', array(
                    'error' => $error
                ));
            }
    ...
    */
    private function createCreateForm(User $entity)
    {
        ...
        //$form->add('submit', 'submit', array('label' => 'create user', 'attr' => array('class' => 'btn btn-default btn-lg')));
